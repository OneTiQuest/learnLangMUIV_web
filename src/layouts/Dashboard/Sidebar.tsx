...
function getStuentNav() {
    return (
        <>
            <NavLink to={'/dashboard/grades'} className="flex items-center px-6 py-2 mt-4 text-muiv transition duration-300 hover:bg-muiv hover:bg-opacity-25 hover:text-white">
...
function getTeacherNav() {
    return (
        <>
            <NavLink to={'/dashboard/grades'} className="flex items-center px-6 py-2 mt-4 text-muiv transition duration-300 hover:bg-muiv bg-opacity-25 hover:text-white">
                <svg className="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
function getAdminNav() {
    return (
        <>
            ...
            <NavLink className="flex items-center px-6 py-2 mt-4 text-muiv transition duration-300 hover:bg-muiv hover:bg-opacity-25 hover:text-white" to={'/dashboard/langs'}>
                <svg className="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                </svg>

                <span className="mx-3">Языки</span>
            </NavLink>

            <NavLink className="flex items-center px-6 py-2 mt-4 text-muiv transition duration-300 hover:bg-muiv hover:bg-opacity-25 hover:text-white" to={'/dashboard/cources'}>
                <svg className="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                </svg>

                <span className="mx-3">Направления</span>
            </NavLink>
        </>
    );
}
    ...
    return (
        <>
            ...
            <div className={`fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto transition duration-300 transform bg-stone-300 lg:translate-x-0 lg:static lg:inset-0 ${isOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'}`}>
                <NavLink to={'/dashboard'} className="flex items-center justify-center mt-8">
